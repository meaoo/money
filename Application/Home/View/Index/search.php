                ...
                <div class="col-md-9 col-sm-12" style="padding: 0;">
                    ...
                    <div class="row">
                        <div class="col-md-12" style="padding: 0;margin-bottom: 10px;">
                            <div class="title">
                                <include file="tag_list"/>
                            </div>
                        </div>
                    </div>

                    <div style="background-color: #fff;border:solid 1px #e3e3e3;">
                        <div class="msg_bar"><p style="float:left;">搜索</p><p style="float:left;color:green;">"{$keyword}"</p>共<span style="color:green;">{$count}</span>条职位信息</div>
                    ...
                    <div style="width: 100%;height: auto;">
                        <div style="width: 100%;height: auto;">
                            <div class="panel panel-default">
                                <div class="panel-heading">热门职位</div>
                                <div class="panel-body hot_job" style="padding: 0;">
                                    <ul>
                                        <volist name="newest" id="v">
                                            <li><a href="{:U('Home/Index/detail',array('id'=>$v[id]))}" target="_blank">{$v.title}</a> </li>
                                        </volist>
                                    </ul>
                                </div>
                            </div>
