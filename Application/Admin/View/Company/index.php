            ...
            <ul class="sidebar-menu">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub" style="display: block">
                        <li class="active"><a class="" href="{:U('Admin/Company/index')}">公司列表</a></li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li><a class="" href="{:U('Admin/Category/addcat')}">添加类型</a></li>
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <table class="table table-striped table-advance table-hover">
                            <thead>
                            <tr>
                                <th><i class="icon-bullhorn"></i> 公司id</th>
                                <th class="hidden-phone"><i class="icon-question-sign"></i> 公司名称</th>
                                <th class="hidden-phone"><i class="icon-question-sign"></i> 类型</th>
                                <th>操作</th>
                            </tr>
                            </thead>
                            <tbody>
                            <foreach name='data' item='v'>
                                <tr>
                                    <td><a href="#">{$v.id}</a></td>
                                    <td class="hidden-phone">{$v.company}</td>
                                    <td class="hidden-phone">
                                        <if condition="$v['page']==0">
                                            成功案例
                                            <else/>
                                            管理页面
                                        </if>
                                    ...
                                    <td>
                                        <a href="{:U('Company/editCompany',array(id=>$v['id']))}"><button class="btn btn-primary btn-xs"><i class="icon-pencil"></i></button></a>
                                        <a href="{:U('Company/deleteCompany',array(id=>$v['id']))}"> <button class="btn btn-danger btn-xs" ><i class="icon-trash "></i></button></a>
                                    </td>
                                </tr>
                            </tbody>
                            </foreach>
