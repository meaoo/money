            ...
            <ul class="sidebar-menu">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub" style="display: block">
                        ...
                        <li class="active"><a class="" href="{:U('Admin/Company/addCompany')}">添加公司</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;" class="">
                            ...
                            <div class=" form">
                                <form class="cmxform form-horizontal tasi-form" id="commentForm" method="post" action="" enctype="multipart/form-data">
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-10">
                                            <input  name="photo" minlength="2" type="file" required />
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="ccomment" class="control-label col-lg-2">公司名称</label>
                                        <div class="col-lg-10">
                                            <input class="form-control " id="cemail" type="text" name="company" />
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="ccomment" class="control-label col-lg-2">公司简介</label>
                                        <div class="col-lg-10" style="hight:100%;">
                                            <textarea class="form-control " class="ccomment" name="detail"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-10" style="hight:100%;">
                                            <textarea class="form-control " class="ccomment" name="text" style="height: 500px;"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="ccomment" class="control-label col-lg-2">页面管理</label>
                                        <div class="col-lg-10" style="hight:100%;">
                                           <select name="page">
                                               <option value="0">成功案例</option>
                                               <option value="1">管理页面</option>
                                           </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
