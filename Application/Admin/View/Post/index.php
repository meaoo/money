                  ...
                  <li class="sub-menu">
                   ...
                   <li class="sub-menu">
                      ...
                      <ul class="sub" style="display:block;">
                          <li class="active"><a class="" href="{:U('Admin/Post/index')}">岗位列表</a></li>
                          <li><a class="" href="{:U('Admin/Post/addpost')}">添加岗位</a></li>
                          <li ><a class="" href="{:U('Admin/Post/editpost')}">编辑岗位</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;" class="">
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <table class="table table-striped table-advance table-hover">
                              <thead>
                              <tr>
                                  <th><i class="icon-bullhorn"></i> 岗位类型id</th>
                                  <th class="hidden-phone"><i class="icon-question-sign"></i> 岗位</th>
                                  <th>操作</th>
                              </tr>
                              </thead>
                              <tbody>
                              ...
                              <tr>
                                  ...
                                  <td>
                                     <a href="{:U('Post/editpost',array(id=>$v['id']))}"><button class="btn btn-primary btn-xs"><i class="icon-pencil"></i></button></a>
                                     <a href="{:U('Post/deletepost',array(id=>$v['id']))}"> <button class="btn btn-danger btn-xs" ><i class="icon-trash "></i></button></a>
                                  </td>
                              </tr>
                              </tbody>
                              </foreach>
