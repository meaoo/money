              ...
              <if condition="$_SESSION['status']==1">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub" style="display:block;">
                          ...
                          <li class="active"><a class="" href="{:U('Admin/Post/editpost')}">编辑岗位</a></li>
                          ...
                          <div class="panel-body">
                              <form role="form" class="form-horizontal tasi-form" method="post">
                                  <div class="form-group has-success">
                                      ...
                                      <div class="col-lg-10">
                                          <input type="text" placeholder="" id="f-name" class="form-control" name="category" value="{$data.postname}">
                                      </div>
                                  </div>
       ...
       var ass=$(this).serialize();
        $.ajax({
			    ...
			    if(data==1){
                  ...
                  $('#text').show();
                  $('#text').html('编辑岗位成功');
                  location.href="<?php echo U('Admin/Post/index');?>";
                }
				}
			});
       return false;     
