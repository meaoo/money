                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form role="form" class="form-horizontal tasi-form" action="" method="post">
                                <div class="form-group has-success">
                                    <label class="col-lg-2 control-label">顾问名称</label>
                                    <div class="col-lg-10">
                                       {$name.name}
                                    </div>
                                </div>
                                <div class="form-group has-success">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" placeholder="请输入数字" id="f-name" class="form-control" name="top" value="{$name.top}" >
                                    </div>
                                </div>
