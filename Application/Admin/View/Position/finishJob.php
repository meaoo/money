            ...
            <ul class="sidebar-menu">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li class="active"><a  href="{:U('Admin/Position/finishJob')}">完成职位</a></li>
                    </ul>
                </li>
                        ...
                        <table class="table table-striped table-advance table-hover">
                            ...
                            <foreach name='data' item='v'>
                                <tr>
                                    ...
                                    <td>
                                        <a href="{:U('Position/editFinish',array(id=>$v['id']))}"><button class="btn btn-primary btn-xs"><i class="icon-pencil"></i></button></a>
                                    </td>
                                </tr>
                            </tbody>
                            </foreach>
