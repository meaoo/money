            ...
            <ul class="sidebar-menu">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li class="active"><a  href="{:U('Admin/Position/person')}">顾问排序</a></li>
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <table class="table table-striped table-advance table-hover">
                            <thead>
                            <tr>
                                <th><i class="icon-bullhorn"></i> 顾问id</th>
                                <th class="hidden-phone"><i class="icon-question-sign"></i> 顾问名称</th>
                                <th>操作</th>
                            </tr>
                            </thead>
                            <tbody>
                            <foreach name='data' item='v'>
                                <tr>
                                    ...
                                    <td>
                                        <a href="{:U('Position/editPerson',array(id=>$v['id']))}"><button class="btn btn-primary btn-xs"><i class="icon-pencil"></i></button></a>
                                    </td>
                                </tr>
                            </tbody>
                            </foreach>
