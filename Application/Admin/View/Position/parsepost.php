                    ...
                    <li class="sub-menu">
                     ...
                     <li class="sub-menu">
                      ...
                      <ul class="sub" style="display:block;">
                           <li class=""><a class="" href="{:U('Admin/Position/index')}">职位列表</a></li>
                          <li><a class="" href="{:U('Admin/Position/addpost')}">发布信息</a></li>
                          <li class="active"><a class="" href="{:U('Admin/Position/parsepost')}">暂停招聘</a></li>
                      ...
                      <section class="panel">
                          ...
                          <table class="table table-striped table-advance table-hover">
                              ...
                              <tr>
                                  ...
                                  <td>
                                     <a href="{:U('Position/detail',array(id=>$v['id']))}"> <button type="button" class="btn btn-success"> 查看 </button></a>
                                     <a href="{:U('Position/resetpost',array(id=>$v['id']))}"><button type="button" class="btn btn-info "> 恢复招聘</button></a>
                                  </td>
                              </tr>
                              </tbody>
                              </foreach>
