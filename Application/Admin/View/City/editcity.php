              ...
              <if condition="$_SESSION['status']==1">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                         ...
                         <li class=""><a class="" href="{:U('Admin/Category/addcat')}">添加类型</a></li>
                         <li class="active"><a class="" href="{:U('Admin/Category/editcat')}">编辑类型</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;" class="">
                      ...
                      <ul class="sub">
                          ...
                          <li><a class="" href="{:U('Admin/Job/editjob')}">编辑分类</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;" class="">
                      ...
                      <ul class="sub" style="display:block;">
                         <li><a class="" href="{:U('Admin/City/index')}">城市列表</a></li>
                          ...
                          <li class="active"><a class="" href="{:U('Admin/City/editcity')}">编辑城市</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;" class="">
                          ...
                          <div class="panel-body">
                              <form role="form" class="form-horizontal tasi-form">
                                  <div class="form-group has-success">
                                      <label class="col-lg-2 control-label">城市名称</label>
                                      <div class="col-lg-10">
                                          <input type="text" placeholder="" id="f-name" class="form-control" name="city" value="{$data.name}">
                                      </div>
                                  </div>
       ...
       var ass=$(this).serialize();
        $.ajax({
			    ...
			    if(data==1){
                  ...
                  $('#text').show();
                  $('#text').html('编辑城市成功');
                  location.href="<?php echo U('Admin/City/index');?>";
                }
				}
			});
       return false;     
