              ...
              <if condition="$_SESSION['status']==1">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub" style="display:block;">
                          ...
                          <li class="active"><a class="" href="{:U('Admin/Job/editjob')}">编辑分类</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;" class="">
                          ...
                          <div class="panel-body">
                              <form role="form" class="form-horizontal tasi-form">
                                  <div class="form-group has-success">
                                      ...
                                      <div class="col-lg-10">
                                          <input type="text" placeholder="" id="f-name" class="form-control" name="job" value="{$data.name}">
                                      </div>
                                  </div>
       ...
       var ass=$(this).serialize();
        $.ajax({
			    ...
			    if(data==1){
                  ...
                  $('#text').show();
                  $('#text').html('编辑职位成功');
                  location.href="<?php echo U('Admin/Job/index');?>";
                }
				}
			});
       return false;     
