            ...
            <ul class="sidebar-menu">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub" style="display: block">
                        ...
                        <li class="active"><a class="" href="{:U('Admin/Person/addPerson')}">编辑资料</a></li>
                            ...
                            <div class=" form">
                                <form class="cmxform form-horizontal tasi-form" id="commentForm" method="post" action="" enctype="multipart/form-data">
                                    <div class="form-group ">
                                        <label for="cname" class="control-label col-lg-2">用户照片</label>
                                        <div class="col-lg-10">
                                            <input  name="photo" minlength="2" type="file" />
                                            <input  name="photoOne" minlength="2" type="hidden" value="{$user.photo}"/>
                                            <input  name="id" minlength="2" type="hidden" value="{$user.id}"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group ">
                                        <label for="ccomment" class="control-label col-lg-2">用户简介</label>
                                        <div class="col-lg-10" style="hight:100%;">
                                            <textarea class="form-control " class="ccomment" name="detail">{$user.detail}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="ccomment" class="control-label col-lg-2">擅长领域</label>
                                        <div class="col-lg-10" style="hight:100%;">
                                            <input class="form-control " class="ccomment" name="perfect" value="{$user.perfect}" ></input>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="ccomment" class="control-label col-lg-2">微信号</label>
                                        <div class="col-lg-10" style="hight:100%;">
                                            <input class="form-control " class="ccomment" name="weixin" value="{$user.weixin}" ></input>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="ccomment" class="control-label col-lg-2">电话号码</label>
                                        <div class="col-lg-10" style="hight:100%;">
                                            <input class="form-control " class="ccomment" name="tel" value="{$user.tel}" ></input>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="ccomment" class="control-label col-lg-2">猎头经纪人名称</label>
                                        <div class="col-lg-10" style="hight:100%;">
                                            <textarea class="form-control " class="ccomment" name="name">{$user.name}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="ccomment" class="control-label col-lg-2">个人连接</label>
                                        <div class="col-lg-10" style="hight:100%;">
                                            <input type="text" class="form-control " class="ccomment" name="linkin" value="{$user.linkin}" placeholder="连接前必须添加http://"></input>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="ccomment" class="control-label col-lg-2">是否前台显示</label>
                                        <div class="col-lg-10" style="hight:100%;">
                                            <if condition="$user['status']==1">
                                                <input  name="status" minlength="2" type="checkbox" value="1" checked/>
                                                <else/>
                                                <input  name="status" minlength="2" type="checkbox" value="1"/>
                                            </if>
