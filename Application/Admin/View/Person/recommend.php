            ...
            <ul class="sidebar-menu">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub" style="display: block">
                        ...
                        <li class=""><a class="" href="{:U('Admin/Person/addPerson')}">编辑资料</a></li>
                        <li><a class="" href="{:U('Admin/Person/logo')}">二维码</a></li>
                        <li class="active"><a  href="{:U('Admin/Person/recommend')}">我的业绩</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;" class="">
                            ...
                            <div class=" form">
                                <form class="cmxform form-horizontal tasi-form" id="commentForm" method="post" action="" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group ">
                                        <label for="ccomment" class="control-label col-lg-2">上岗</label>
                                        <div class="col-lg-4" style="hight:100%;">
                                            <input class="form-control " class="ccomment" name="job" value="{$data.job}"></>
                                        </div>
                                        <label for="ccomment" class="control-label col-lg-2">客户offer数</label>
                                        <div class="col-lg-4" style="hight:100%;">
                                        <input class="form-control " class="ccomment" name="customer" value="{$data.customer}" ></input>
                                        </div>
                                    </div>
                                   
                                    <div class="form-group ">
                                        <label for="ccomment" class="control-label col-lg-2">客户面试</label>
                                        <div class="col-lg-4" style="hight:100%;">
                                            <input class="form-control " class="ccomment" name="interview" value="{$data.interview}"></input>
                                        </div>
                                        <label for="ccomment" class="control-label col-lg-2">推荐</label>
                                        <div class="col-lg-4" style="hight:100%;">
                                            <input class="form-control " class="ccomment" name="referee" value="{$data.referee}"></input>
                                        </div>
                                    </div>
                                      <header class="panel-heading">
                                           全部业绩
                                            ...
                                            <div class="form-group " style="margin-top: 20px;">
                                                <label for="ccomment" class="control-label col-lg-2">上岗</label>
                                                <div class="col-lg-4" style="hight:100%;">
                                                    <input class="form-control " class="ccomment" name="job-p" value="{$data.job-p}"></>
                                            </div>
                                            <label for="ccomment" class="control-label col-lg-2">客户offer数</label>
                                            <div class="col-lg-4" style="hight:100%;">
                                                <input class="form-control " class="ccomment" name="customer-p" value="{$data.customer-p}" ></input>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group ">
                                            <label for="ccomment" class="control-label col-lg-2">客户面试</label>
                                            <div class="col-lg-4" style="hight:100%;">
                                                <input class="form-control " class="ccomment" name="interview-p" value="{$data.interview-p}"></input>
                                            </div>
                                            <label for="ccomment" class="control-label col-lg-2">推荐</label>
                                            <div class="col-lg-4" style="hight:100%;">
                                                <input class="form-control " class="ccomment" name="referee-p" value="{$data.referee-p}"></input>
                                            </div>
                                        </div>
                                    <div class="form-group">
