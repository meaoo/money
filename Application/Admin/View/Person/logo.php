            ...
            <ul class="sidebar-menu">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub" style="display: block">
                        ...
                        <li class="active"><a class="" href="{:U('Admin/Person/logo')}">二维码</a></li>
                            ...
                            <div class=" form">
                                <form class="cmxform form-horizontal tasi-form" id="commentForm" method="post" action="" enctype="multipart/form-data">
                                    <div class="form-group ">
                                        <label for="cname" class="control-label col-lg-2">图片二维码</label>
                                        <div class="col-lg-10">
                                            <input  name="logo" minlength="2" type="file" />
                                            <input  name="logoOne" minlength="2" type="hidden" value="{$user.logo}"/>
                                            <input  name="id" minlength="2" type="hidden" value="{$user.id}"/>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="cname" class="control-label col-lg-2">个人二维码</label>
                                        <div class="col-lg-10">
                                            <input  name="person" minlength="2" type="file" />
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="cname" class="control-label col-lg-2">个人小图片</label>
                                        <div class="col-lg-10">
                                            <input  name="personLogo" minlength="2" type="file" />
                                        </div>
                                    </div>
