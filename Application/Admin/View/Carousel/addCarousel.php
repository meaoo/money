            ...
            <ul class="sidebar-menu">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub" >
                        ...
                        <li class="active"><a  href="{:U('Admin/Person/addPerson')}">编辑资料</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;" class="">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub" style="display:block;">
                        ...
                        <li class="active"><a class="" href="{:U('Admin/Carousel/addCarousel')}">添加图片</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;" class="">
                        ...
                        <div class="panel-body">
                            <div class=" form">
                                <form class="cmxform form-horizontal tasi-form" id="commentForm" method="post" action="" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group ">
                                        <label for="ccomment" class="control-label col-lg-2">图片地址(以http://开头)</label>
                                        <div class="col-lg-10">
                                            <input class="form-control " id="cemail" type="text" name="url" required/>
                                        </div>
                                    </div>
