            ...
            <ul class="sidebar-menu">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub" style="display: block">
                        ...
                        <li class="active"><a class="" href="{:U('Admin/Carousel/addCarousel')}">编辑图片</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;" class="">
                            ...
                            <div class=" form">
                                <form class="cmxform form-horizontal tasi-form" id="commentForm" method="post" action="" enctype="multipart/form-data">
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-10">
                                            <img src="__UPLOAD__/{$company.img}" style="max-width:200px;max-height:200px;" id="img">
                                            <input  name="photo" minlength="2" type="file" onchange='PreviewImage(this)' id="info_photo"/>
                                            <input  name="photo_hidden" minlength="2" type="hidden" value="{$company.img}"/>
                                            <input  name="companyId" minlength="2" type="hidden" value="{$company.id}"/>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="ccomment" class="control-label col-lg-2">ur地址</label>
                                        <div class="col-lg-10">
                                            <input class="form-control " id="cemail" type="text" name="url" value="{$company.url}" required/>
                                        </div>
                                    </div>
                                    <div class="form-group">
