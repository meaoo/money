            ...
            <ul class="sidebar-menu">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub" >
                        ...
                        <li ><a  href="{:U('Admin/Person/addPerson')}">编辑资料</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;" class="">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub" style="display:block;">
                        <li class="active"><a class="" href="{:U('Admin/Carousel/index')}">图片列表</a></li>
                    ...
                    <section class="panel">
                        ...
                        <table class="table table-striped table-advance table-hover">
                            ...
                            <foreach name='data' item='v'>
                                <tr>
                                    <td><a href="#">{$v.id}</a></td>
                                    <td class="hidden-phone">{$v.url}</td>
                                    
                                    <td>
                                        <a href="{:U('Carousel/editCarousel',array(id=>$v['id']))}"><button class="btn btn-primary btn-xs"><i class="icon-pencil"></i></button></a>
                                        <a href="{:U('Carousel/deleteCarousel',array(id=>$v['id']))}"> <button class="btn btn-danger btn-xs" ><i class="icon-trash "></i></button></a>
                                    </td>
                                </tr>
                            </tbody>
                            </foreach>
