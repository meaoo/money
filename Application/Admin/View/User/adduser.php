              ...
              <if condition="$_SESSION['status']==1">
                  <li class="sub-menu">
                      ...
                      <ul class="sub" style="display:block;">
                          ...
                          <li class="active"><a class="" href="{:U('Admin/User/adduser')}">添加用户</a></li>
                          <li><a class="" href="{:U('Admin/User/clearcache')}">清除缓存</a></li>
                          ...
                          <div class="panel-body">
                              <form role="form" class="form-horizontal tasi-form">
                                  <div class="form-group has-success">
                                      ...
                                      <div class="col-lg-10">
                                          <input type="text" placeholder="" id="f-name" class="form-control" name="username">
                                      </div>
                                  </div>
