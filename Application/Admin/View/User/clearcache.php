              ...
              <if condition="$_SESSION['status']==1">
                  <li class="sub-menu">
                      ...
                      <ul class="sub" style="display:block;">
                          ...
                          <li class="active"><a class="" href="{:U('Admin/User/clearcache')}">清除缓存</a></li>
                      ...
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <form role="form" class="form-horizontal tasi-form">
                                          ...
                                          <input type="hidden" placeholder="" id="f-name" class="form-control" name="username">
                                
                               

                                  <div class="form-group">
                                      <div class=" col-lg-10">
                                          <button class="btn btn-danger" type="submit">清除缓存</button>
                                      </div>
                                  </div>
                              </form>
                          </div>
