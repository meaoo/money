              ...
              <if condition="$_SESSION['status']==1">
                  ...
                  <li class="sub-menu">
                     ...
                     <ul class="sub">
                           ...
                           <li><a class="" href="{:U('Admin/Position/detail')}">招聘详情</a></li>
                      </ul>
                  </li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub" style="display:block;">
                          ...
                          <li class="active"><a class="" href="{:U('Admin/Appliy/detail')}">详情信息</a></li>
                      </ul>
                  </li>
                              ...
                              <div class=" form">
                                  <form class="cmxform form-horizontal tasi-form" id="commentForm" method="post" action="">
                                      <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">申请职位</label>
                                          <div class="col-lg-10">
                                             {$data.title}
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="cemail" class="control-label col-lg-2">申请人</label>
                                          <div class="col-lg-10">
                                              {$data.name}
                                          </div>
                                      </div>
                                <div class="form-group">
                                      <label class="control-label col-lg-2" for="inputSuccess">申请人邮箱</label>
                                      <div class="col-lg-10">
                                          {$data.email}
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="control-label col-lg-2" for="inputSuccess">留言信息</label>
                                      <div class="col-lg-10">
                                  ...
                                  <div class="form-group">
                                      <label class="control-label col-lg-2" for="inputSuccess">申请时间</label>
                                      <div class="col-lg-10">
                                         {$data.created_on}
                                      </div>
                                  </div>
                                      <div class="form-group ">
                                          <label for="ccomment" class="control-label col-lg-2">电话</label>
                                          <div class="col-lg-10">
                                             <if condition="$data['telephone']==0">
                                             没有
                                             <else/>
                                             {$data.telephone}
                                             </if>
                                        ...
                                        <div class="form-group ">
                                          <label for="cemail" class="control-label col-lg-2">下载简历</label>
                                          <div class="col-lg-10">
                                           <if condition="$data['cv_path']!=NULL">
                                               <a href="__UPLOAD__/{$data.cv_path}"> <button type="button" class="btn btn-default ">下载</button></a>
                                             <else/>
                                             没有简历上传
                                             </if>
