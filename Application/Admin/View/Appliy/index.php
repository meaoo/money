              ...
              <if condition="$_SESSION['status']==1">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub" style="display:block;">
                         <li class="active"><a class="" href="{:U('Admin/Appliy/index')}">申请列表</a></li>
                      </ul>
                  </li>
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <table class="table table-striped table-advance table-hover">
                              <thead>
                              <tr>
                                  <th><i class="icon-bullhorn"></i> 申请id</th>
                                  <th class="hidden-phone"><i class="icon-question-sign"></i>申请人</th>
                                  <th><i class=" icon-edit"></i>申请职位</th>
                                  <th><i class=" icon-arrow-down"></i>简历下载</th>
                                  <th>操作</th>
                              </tr>
                              </thead>
                              <tbody>
                              ...
                              <tr>
                                  ...
                                  <if condition="$v['cv_path']!=NULL">
                                 <a href="__UPLOAD__/{$v.cv_path}"> <button type="button" class="btn btn-default "> 下载</button></a>
                                  <else/>
                                  无简历
                                  </if>
                                  </td>
                                  <td>
                                       <a href="{:U('Appliy/detail',array(id=>$v['id']))}"> <button type="button" class="btn btn-success">查看 </button></a>
                                  </td>
                              </tr>
                              </tbody>
                              </foreach>
