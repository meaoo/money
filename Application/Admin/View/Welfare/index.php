                  ...
                  <li class="sub-menu">
                    ...
                    <li class="sub-menu">
                      ...
                      <ul class="sub" style="display:block;">
                          <li class="active"><a class="" href="{:U('Admin/Welfare/index')}">标签列表</a></li>
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <table class="table table-striped table-advance table-hover">
                              <thead>
                              <tr>
                                  <th><i class="icon-bullhorn"></i> 标签id</th>
                                  <th class="hidden-phone"><i class="icon-question-sign"></i> 福利名称</th>
                                  <th>操作</th>
                              </tr>
                              </thead>
                              <tbody>
                              ...
                              <tr>
                                  ...
                                  <td>
                                     <a href="{:U('Welfare/editlist',array(id=>$v['id']))}"><button class="btn btn-primary btn-xs"><i class="icon-pencil"></i></button></a>
                                     <a href="{:U('Welfare/deletelist',array(id=>$v['id']))}"> <button class="btn btn-danger btn-xs" ><i class="icon-trash "></i></button></a>
                                  </td>
                              </tr>
                              </tbody>
                              </foreach>
