                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                         <li><a class="" href="{:U('Admin/Job/index')}">分类列表</a></li>
                          <li class="active"><a class="" href="{:U('Admin/Job/addjob')}">添加分类</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;" class="">
                      ...
                      <ul class="sub" >
                          ...
                          <li class=""><a class="" href="{:U('Admin/City/addcity')}">添加城市</a></li>
                      </ul>
                  </li>
                    <li class="sub-menu">
                      <a href="javascript:;" class="">
                      ...
                      <ul class="sub" style="display:block;">
                          ...
                          <li class="active"><a class="" href="{:U('Admin/Welfare/addlist')}">添加标签</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;" class="">
                          ...
                          <div class="panel-body">
                              <form role="form" class="form-horizontal tasi-form">
                                  <div class="form-group has-success">
                                      ...
                                      <div class="col-lg-10">
                                          <input type="text" placeholder="" id="f-name" class="form-control" name="list" value="{$data.content}">
                                      </div>
                                  </div>
       ...
       var ass=$(this).serialize();
        $.ajax({
			    ...
			    if(data==1){
                  ...
                  $('#text').show();
                  $('#text').html('编辑标签成功');
                  location.href="<?php echo U('Admin/Welfare/index');?>";
                }else{
                   $('#text').show();
                   $('#text').html('城市名称重复');
                }
