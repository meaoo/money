...
class Page{
    ...
    public $queryParameter; // 非ASCII字符参数，如 汉字
    ...
    public function show() {
        ...
        $this->url = QU ( U(ACTION_NAME, $this->parameter), $this->queryParameter);
        /* 计算分页信息 */
        ...
        $page_str = str_replace(
            ...
            $this->config['theme']);
        return "<div class=\"pagination-box\"><ul  class=\"pagination\">{$page_str}</ul></div>";
    }
}
